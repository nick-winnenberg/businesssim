...
class Business(models.Model):
    ...
    yearsProfessionalExperince = models.IntegerField(default=5, verbose_name="How many years of Professional Experince in your field?", validators=[MinValueValidator(0), MaxValueValidator(50)])
    yearsofBusinessEducationExperince = models.IntegerField(default=5, verbose_name="How many years of Formal Business Education?", validators=[MinValueValidator(0), MaxValueValidator(50)])
